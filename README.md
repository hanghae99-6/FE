 ...
 <h3 align="left">🤔FE Trouble Shooting</h3>  
  ...
  <details>
    <summary>로그인 없이 이용가능한 서비스 개발</summary>
      <div markdown="1">
        <br>
        "로그인을 하지 않으면 참여할 수 있는 서비스가 없어 아쉽다" 라는 의견. 건전한 페이지 운영을 위해 유저정보가 필수라고 판단되는 범위의 서비스 이외에는 모든 유저가 참여할 수 있도록 변경. hotpeech, 원클릭 찬반토론과 토론 상세페이지 찬반 투표 등의 여론을 확인 할 수 있는 서비스는 유저 정보가 아닌 ip주소를 기반으로 정보 수집 할 수 있도록 기능을 개선함.
      </div>
   </details>
